...
* [RFC-0005](https://github.com/peercoin/rfcs/blob/master/text/0005-unspendable-zero-outputs/0005-unspendable-zero-outputs.md): Prunes zero value outputs from UTXO set.
* [RFC-0020](https://github.com/peercoin/rfcs/blob/master/text/0020-pow-difficulty-on-pos-blocks/0020-pow-difficulty-on-pos-blocks.md): Reduces PoW difficulty on new PoS blocks if PoW block is overdue.
