...
|:------------:	|:-------------------------------------------------------------------------------------------------:	|:--------------------------------------------------------------:	|:----------------------------:	|
|     Init     	| (base_token_id, target_token_id, option_token_id, proof_token_id, execute_time, execute_deadline) 	| (token_id, token_id, token_id, token_id, timestamp, timestamp) 	| Register a V Option contract 	|
<br/>
...
|:------------------------:	|:---------------:	|:----------------------------------------:	|:------------------------:	|:--------------------------------------------------------------------------------------------------------------------------:	|
|         Supersede        	|        0        	|               ("new_owner")              	|         (address)        	|                                               Transfer ownership of contract                                               	|
|         Activate         	|        1        	| ("max_issue_num", "price", "price_unit") 	| (amount, amount, amount) 	|                     Activate the V Option contract to store option token and proof token into the pool.                    	|
|           Mint           	|        2        	|                ("amount")                	|         (amount)         	|                           Mint target tokens into the pool to get option tokens and proof tokens.                          	|
|          Unlock          	|        3        	|                ("amount")                	|         (amount)         	|                   Get the remaining option tokens and proof tokens from the pool before the execute time.                  	|
|          Execute         	|        4        	|                ("amount")                	|         (amount)         	|                            Execute the V Option contract to get target token after execute time.                           	|
|          Collect         	|        5        	|                ("amount")                	|         (amount)         	| Collect the base tokens or/and target tokens from the pool depending on the amount of proof tokens after execute deadline. 	|
...
activate_data_stack = voption_contract_elper.activate_data_stack_generator(<max_issue_num>, <price>, <price_unit>)
...
|:------------------:	|:------------------------:	|:----------------------------------------------------------------------------------:	|
|        maker       	|             0            	|                  The address of the maker of the V Option contract                 	|
|     baseTokenId    	|             1            	|               The token id of the base token of the V Option contract              	|
|    targetTokenId   	|             2            	|              The token id of the target token of the V Option contract             	|
|    optionTokenId   	|             3            	|              The token id of the option token of the V Option contract             	|
|    proofTokenId    	|             4            	|              The token id of the proof token of the V Option contract              	|
|     executeTime    	|             5            	|                The execute time the V Option contract in nanoseconds               	|
|   executeDeadline  	|             6            	|          The execute deadline time of the V Option contract in nanoseconds         	|
|    optionStatus    	|             7            	|                         The status of the V Option contract                        	|
|     maxIssueNum    	|             8            	|                The number of the maximum issue of the option tokens                	|
|   reservedOption   	|             9            	| The amount of the reserved option tokens remaining in the pool of V Optioncontract 	|
|    reservedProof   	|            10            	| The amount of the reserved proof tokens remaining in the pool of V Option contract 	|
|        price       	|            11            	|                  The price of the creator of the V Option contract                 	|
|      priceUnit     	|            12            	|               The price unit of the creator of the V Option contract               	|
|     tokenLocked    	|            13            	|                 The address of the creator of the V Option contract                	|
|   tokenCollected   	|            14            	|           The amount of the base tokens in the pool of V Option contract           	|

<br/>

|    **State Map**   	| **State Map Index** 	|   **State Map Key**  	|                **Description**               	|
|:------------------:	|:-------------------:	|:--------------------:	|:--------------------------------------------:	|
|  baseTokenBalance  	|          0          	| userAddress(address) 	|  The base token balance of the user address  	|
| targetTokenBalance 	|          1          	| userAddress(address) 	| The target token balance of the user address 	|
| optionTokenBalance 	|          2          	| userAddress(address) 	| The option token balance of the user address 	|
|  proofTokenBalance 	|          3          	| userAddress(address) 	|  The proof token balance of the user address 	|
